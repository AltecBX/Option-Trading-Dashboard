...
function StLadder({
  ...
  return /*#__PURE__*/React.createElement("table", {
    ...
    className: "scan-num",
    title: ST_TIP.itm
  }, "Finished through"), /*#__PURE__*/React.createElement("th", {
    className: "scan-num",
    title: ST_TIP.touch
  }, "Touched"), /*#__PURE__*/React.createElement("th", {
    className: "scan-num",
    title: "Average result of selling this strike over the comparable crossings, on the collateral it ties up, annualised"
  }, "EV / yr"), /*#__PURE__*/React.createElement("th", {
    title: "Fill quality: spread and open interest"
  }, "Fill"), /*#__PURE__*/React.createElement("th", {
    title: "Why this strike was refused, if it was"
  }, "Gate"))), /*#__PURE__*/React.createElement("tbody", null, rows.map(x => /*#__PURE__*/React.createElement("tr", {
    key: x.strike,
    className: x.gate ? "st-gated" : ""
  }, /*#__PURE__*/React.createElement("td", null, stNum(x.strike, 2), " ", side), /*#__PURE__*/React.createElement("td", {
    className: "scan-num"
  }, x.delta == null ? "—" : Math.abs(x.delta).toFixed(2)), /*#__PURE__*/React.createElement("td", {
    className: "scan-num"
  }, stMoney(x.credit)), /*#__PURE__*/React.createElement("td", {
    className: "scan-num"
  }, stPct0(x.itm_pct), x.itm_pct != null && limit != null && x.itm_pct > limit * 100 ? " ▲" : ""), /*#__PURE__*/React.createElement("td", {
    className: "scan-num"
  }, stPct0(x.touch_pct)), /*#__PURE__*/React.createElement("td", {
    className: "scan-num"
  }, x.ev_ann_pct == null ? "—" : stPct(x.ev_ann_pct, 0)), /*#__PURE__*/React.createElement("td", null, x.liq_grade || "—"), /*#__PURE__*/React.createElement("td", {
    className: "sl-muted"
  }, x.gate || "clears")))));
}
function StDetail({
  ...
  return /*#__PURE__*/React.createElement("div", {
    className: "sk-detail-wrap st-detail-wrap"
  }, /*#__PURE__*/React.createElement("div", {
    className: "sk-detail-head"
  }, /*#__PURE__*/React.createElement("b", null, r.symbol, " ", r.side), " \xB7 ", r.horizon, " \xB7 ", stDate(r.expiration), ready ? /*#__PURE__*/React.createElement("span", null, " \xB7 ", stNum(r.strike, 2), " ", r.side) : null, /*#__PURE__*/React.createElement("button", {
  ...
  }, "Where it is"), /*#__PURE__*/React.createElement("p", null, r.symbol, " is ", /*#__PURE__*/React.createElement("b", null, stPct(r.move_pct)), " from ", r.anchor_label, " (", stMoney(r.anchor), "), which is ", /*#__PURE__*/React.createElement("b", null, stSig(r.move_sigma)), " for a stock running at ", stPct0(r.sigma_annual * 100, 0), " annualised. Its usual ", r.side === "call" ? "high" : "low", " on this horizon is ", /*#__PURE__*/React.createElement("b", null, stPct(r.line_pct)), " ", "(", stMoney(r.line_price), ") over ", r.n_windows, " ", r.horizon === "week" ? "weeks" : "days", "; the record is ", stPct(r.record_pct * 100, 1), " \u2014 context, not a ceiling."), r.n != null ? /*#__PURE__*/React.createElement("p", {
    title: ST_TIP.basis
  }, "After ", /*#__PURE__*/React.createElement("b", null, r.n), " comparable crossings (", r.grade, r.n_pool ? `: ${r.n_own} its own, ${r.n_pool} pooled` : "", ";", " ", r.basis, "), the ", r.horizon, " closed back inside the line", " ", /*#__PURE__*/React.createElement("b", null, stPct0((r.p_closed_back || 0) * 100)), " of the time. The typical further travel was", " ", /*#__PURE__*/React.createElement("b", null, stPct(r.median_beyond_pct)), "; nine in ten stayed within ", /*#__PURE__*/React.createElement("b", null, stPct(r.p90_beyond_pct)), ".", r.clamped ? " This move is below the first row of the measured grid, so the nearest row was used." : "") : null, ready ? /*#__PURE__*/React.createElement("p", {
    title: ST_TIP.itm
  }, "The ", /*#__PURE__*/React.createElement("b", null, stNum(r.strike, 2), " ", r.side), " (", Math.abs(r.delta || 0).toFixed(2), "\u0394, ", stPct(r.strike_pct), " from the anchor) pays ", /*#__PURE__*/React.createElement("b", null, stMoney(r.credit)), " at the mid (", stMoney(r.bid), " bid). Comparable crossings finished through a strike this far out ", /*#__PURE__*/React.createElement("b", null, stPct0(r.itm_pct)), " of the time and touched it ", stPct0(r.touch_pct), " of the time.", r.horizon === "day" ? " The whole remaining day is charged here — see the note on same-day expiries." : "") : /*#__PURE__*/React.createElement("p", null, /*#__PURE__*/React.createElement("b", null, "Not ready:"), " ", (r.why || []).join("; ")), ready && r.why && r.why.length ? /*#__PURE__*/React.createElement("ul", {
    className: "sl-muted"
  }, r.why.map((w, i) => /*#__PURE__*/React.createElement("li", {
    key: i
  }, w))) : null), r.ladder && r.ladder.length ? /*#__PURE__*/React.createElement("div", {
    className: "sl-block"
  }, /*#__PURE__*/React.createElement("div", {
    className: "sl-block-title",
    title: ST_TIP.itm
  }, "Every strike in the delta range, against the same crossings", limits ? ` — the limit is ${Math.round(limits.max_itm * 100)}% finished through` : ""), /*#__PURE__*/React.createElement(StLadder, {
    rows: r.ladder,
    side: r.side,
    limit: limits && limits.max_itm
  })) : null, vs ? /*#__PURE__*/React.createElement("div", {
    className: "sl-block",
    title: ST_TIP.vs_monday
  }, /*#__PURE__*/React.createElement("div", {
    className: "sl-block-title"
  }, "Waiting for the line versus selling Monday morning"), /*#__PURE__*/React.createElement("p", null, "Same 20-delta-equivalent rule, two entries, on ", vs.weeks, " weeks of this stock's bars. Sold Monday from last week's close: strike sat ", stPct(vs.monday.strike_from_anchor_pct * 100, 1), " away, finished through ", stPct0(vs.monday.finished_through * 100), ", touched ", stPct0(vs.monday.touched * 100), ". Sold after the line: strike sat ", /*#__PURE__*/React.createElement("b", null, stPct(vs.line.strike_from_anchor_pct * 100, 1)), " away, finished through ", stPct0(vs.line.finished_through * 100), ", touched ", stPct0(vs.line.touched * 100), " \u2014 and the line was reached in ", stPct0(vs.opportunity * 100), " of weeks, typically by ", vs.typical_cross_day, ". Premium is not on the bars: the further strike is what you are paid for.")) : null, /*#__PURE__*/React.createElement("div", {
    className: "sl-block"
  }, /*#__PURE__*/React.createElement("div", {
    className: "sl-block-title"
  }, "What would make this wrong"), /*#__PURE__*/React.createElement("ul", null, /*#__PURE__*/React.createElement("li", null, "The line is not the high. After crossings like this the ", r.horizon, " closed back inside it only", " ", stPct0((r.p_closed_back || 0) * 100), " of the time; the seller is paid for the strike being beyond the further travel, not for a reversal."), /*#__PURE__*/React.createElement("li", null, "The crossing bar is charged in full. Daily bars cannot see whether today's high came before or after the line was reached, so the measured risk is an upper bound \u2014 and for a same-day expiry the whole day is charged."), /*#__PURE__*/React.createElement("li", null, "A headline after you are short. Takeover spikes are refused and a scheduled earnings date inside the trade is refused; nothing catches an unscheduled one."), /*#__PURE__*/React.createElement("li", null, "Pooled evidence is other names' behaviour in this stock's sigma. It is a less specific answer, and it is labelled."))), ref.length ? /*#__PURE__*/React.createElement("div", {
    className: "sl-block",
    title: ST_TIP.refused
  }, /*#__PURE__*/React.createElement("div", {
    className: "sl-block-title"
...
function stStatusFacts(data) {
  return /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement("span", {
    title: ST_TIP.stale
  }, data.as_of ? `Scanned ${stTime(data.as_of)}` : "No scan yet"), data.scanning ? /*#__PURE__*/React.createElement("span", {
    className: "sl-live",
    title: ST_TIP.scanning
  }, " \xB7 watching") : null, /*#__PURE__*/React.createElement("span", {
    title: ST_TIP.near
  }, " \xB7 ", data.n_crossed, " of ", data.universe, " names past a line, ", (data.near || []).length, " within reach"), data.warming ? /*#__PURE__*/React.createElement("span", null, " \xB7 ", data.warming, " still being measured") : null, /*#__PURE__*/React.createElement("span", {
    title: ST_TIP.alerts
  }, " \xB7 ", data.alerts && data.alerts.configured ? `${data.alerts.pushed_today} alert${data.alerts.pushed_today === 1 ? "" : "s"} sent today` : "no push channel configured"), data.limits ? /*#__PURE__*/React.createElement("span", {
    title: ST_TIP.limits
  }, " \xB7 limit ", Math.round(data.limits.max_itm * 100), "% finished through,", " ", data.limits.min_delta.toFixed(2), "\u2013", data.limits.max_delta.toFixed(2), "\u0394") : null, data.pool ? /*#__PURE__*/React.createElement("span", {
    title: ST_TIP.pool
  }, " \xB7 pool ", Object.values(data.pool).reduce((a, s) => a + Object.values(s).reduce((b, n) => b + n, 0), 0).toLocaleString(), " crossings") : null, /*#__PURE__*/React.createElement("span", null, " \xB7 ", data.version));
}
function StretchCard({
  ...
  const [filters, setFilters] = useState(() => {
    try {
      return {
        side: "both",
        horizon: "both",
        ...JSON.parse(localStorage.getItem(ST_FILTER_KEY) || "{}")
      };
    } catch (_e) {
      return {
        side: "both",
  ...
  const setFilter = (k, v) => setFilters(f => {
    ...
    try {
      localStorage.setItem(ST_FILTER_KEY, JSON.stringify(next));
    } catch (_e) {/* per-viewer convenience only */}
    return next;
  });
  ...
  const seg = (k, opts) => /*#__PURE__*/React.createElement("div", {
    className: "st-seg",
    role: "group"
  }, opts.map(([v, label]) => /*#__PURE__*/React.createElement("button", {
    key: v,
    className: `su-more-btn ${filters[k] === v ? "st-seg-on" : ""}`,
    "aria-pressed": filters[k] === v,
    onClick: () => setFilter(k, v)
  }, label)));
  return /*#__PURE__*/React.createElement("div", {
    className: "card sk-card st-card"
  }, /*#__PURE__*/React.createElement("div", {
    className: "card-head"
  }, /*#__PURE__*/React.createElement("div", null, /*#__PURE__*/React.createElement("span", {
    className: "kicker",
    title: ST_TIP.card
  }, "At the line"), /*#__PURE__*/React.createElement("h3", {
    className: "card-title"
  }, "Reached its usual high or low \u2014 what the calls above and puts below pay")), /*#__PURE__*/React.createElement("div", {
    className: "toolbar st-toolbar"
  }, seg("side", [["both", "Both"], ["call", "Calls"], ["put", "Puts"]]), seg("horizon", [["both", "Week + day"], ["week", "This week"], ["day", "Today"]]), /*#__PURE__*/React.createElement("button", {
    ...
    tone: data.market_open ? "stop" : "neutral",
  ...
  }), data.as_of ? `Scanned ${stTime(data.as_of)}` : "No scan yet", data.scanning ? " · watching" : ""), /*#__PURE__*/React.createElement("div", {
    className: "panel-method-body"
  }, stStatusFacts(data))) : /*#__PURE__*/React.createElement("p", {
    className: "sl-status"
  }, /*#__PURE__*/React.createElement(DataStatus, {
    kind: data.scanning ? "loading" : data.as_of ? "cached" : "pending",
    at: data.as_of,
    note: "The watchman re-reads the board every few minutes while the market is open, whether or not this tab is open."
  }), stStatusFacts(data), nNew ? /*#__PURE__*/React.createElement("span", {
    className: "st-new-chip",
    title: ST_TIP.since
  }, " \xB7 ", nNew, " new") : null) : null, /*#__PURE__*/React.createElement(PanelMethod, {
    label: "Method \u2014 what the line is, what the evidence is, and what is refused"
  }, /*#__PURE__*/React.createElement("p", null, "A stock's line is its own median weekly high (or low) from last week's close \u2014 the dashed line on the Analyze chart \u2014 and its median daily high (or low) from yesterday's close. When the price crosses one, every strike beyond it is priced against what happened AFTER comparable crossings on that stock's record: the first bar that reached the level, and only what followed. Finished-through is what assigns you; touched is what you feel. Delta is the market's price, shown beside the measured number, never in place of it."), /*#__PURE__*/React.createElement("p", {
    title: ST_TIP.day_upper
  }, "Daily bars cannot see the time of day a line was crossed, so the crossing bar is charged in full and a same-day expiry is charged the whole day \u2014 an upper bound on the risk. Takeover headlines and earnings inside the trade are refused, and so is a chain with nobody there: a strike without a real bid, a fillable spread and open interest is never priced, and a name with fewer than three such sellable strikes is skipped for five days. Names with thin records borrow the pool, in sigma, and are labelled POOLED.")), busy && !data ? /*#__PURE__*/React.createElement("div", {
    ...
    onClick: load
  }, "Try again")) : null, sorted.length ? /*#__PURE__*/React.createElement("div", {
    className: "scan-table-wrap sk-table-wrap"
  }, /*#__PURE__*/React.createElement("table", {
    className: "scan-table mtable sk-table st-table"
  }, /*#__PURE__*/React.createElement("thead", null, /*#__PURE__*/React.createElement("tr", null, ST_COLS.map(([l, k, t, _f, n]) => th(l, k, t, n)))), /*#__PURE__*/React.createElement("tbody", null, sorted.map(r => {
    const k = stRowKey(r);
    return /*#__PURE__*/React.createElement("tr", {
      key: k,
      className: `scan-row sk-row st-row st-${r.state} ${open === k ? "scan-row-active" : ""}`,
      onClick: () => toggle(r),
      title: "Click for the reasoning, every strike in range, and what was refused on this name"
    }, ST_COLS.map(([label, ck, tipKey, f, numeric]) => /*#__PURE__*/React.createElement("td", {
      key: ck,
      "data-label": label,
      title: ST_TIP[tipKey],
  ...
  }, showNear ? "Hide" : "Show", " within reach (", near.length, ")"), showNear ? near.length ? /*#__PURE__*/React.createElement("table", {
    className: "sl-mini"
    ...
    className: "scan-num",
    title: ST_TIP.line
  }, "Its line"), /*#__PURE__*/React.createElement("th", {
    className: "scan-num",
    title: "How far along the way to the line"
  }, "Of the way"))), /*#__PURE__*/React.createElement("tbody", null, near.map((c, i) => /*#__PURE__*/React.createElement("tr", {
    key: i
  }, /*#__PURE__*/React.createElement("td", null, c.symbol), /*#__PURE__*/React.createElement("td", null, c.horizon), /*#__PURE__*/React.createElement("td", null, c.side), /*#__PURE__*/React.createElement("td", {
    className: "scan-num"
  }, stPct(c.move_pct)), /*#__PURE__*/React.createElement("td", {
    className: "scan-num"
  }, stPct(c.line_pct)), /*#__PURE__*/React.createElement("td", {
    className: "scan-num"
  }, stPct0(c.fraction * 100)))))) : /*#__PURE__*/React.createElement("p", {
    className: "sl-muted"
  }, "Nothing is within reach of a line.") : null, /*#__PURE__*/React.createElement("button", {
    className: "su-more-btn",
  ...
  }, /*#__PURE__*/React.createElement("thead", null, /*#__PURE__*/React.createElement("tr", null, /*#__PURE__*/React.createElement("th", null, "Symbol"), /*#__PURE__*/React.createElement("th", null, "Setup"), /*#__PURE__*/React.createElement("th", {
    title: ST_TIP.refused
  }, "Why"))), /*#__PURE__*/React.createElement("tbody", null, refused.map((x, i) => /*#__PURE__*/React.createElement("tr", {
    key: i
  }, /*#__PURE__*/React.createElement("td", null, x.symbol), /*#__PURE__*/React.createElement("td", null, x.horizon ? `${x.horizon} ${x.side}` : x.gate), /*#__PURE__*/React.createElement("td", null, (x.why || []).join(" · ")))))) : /*#__PURE__*/React.createElement("p", {
    className: "sl-muted"
...
function StretchLineCard({
  ...
  const side = s => {
    ...
    const up = s === "call";
    return /*#__PURE__*/React.createElement("div", {
      className: "sl-block st-side-block",
      key: s
    }, /*#__PURE__*/React.createElement("div", {
      className: "sl-block-title",
      style: {
    ...
    }, up ? "Usual high" : "Usual low", " \xB7 ", stPct(a.line.pct * 100), " from last week's close (", stMoney(a.line.price), ")"), /*#__PURE__*/React.createElement("p", {
      title: ST_TIP.closed_back
    }, "Reached in ", /*#__PURE__*/React.createElement("b", null, vs ? stPct0(vs.opportunity * 100) : "—"), " of ", a.line.n, " weeks", vs && vs.typical_cross_day ? `, typically by ${vs.typical_cross_day}` : "", ". After crossing it, the week closed back ", up ? "below" : "above", " the line", " ", /*#__PURE__*/React.createElement("b", null, stPct0((a.p_closed_back || 0) * 100)), " of the time", " ", "(", a.n, " crossings, ", a.grade.toLowerCase(), ")."), /*#__PURE__*/React.createElement("p", {
      title: ST_TIP.beyond
    }, "Typical further travel past the line ", /*#__PURE__*/React.createElement("b", null, stPct(a.median_beyond_pct * 100)), "; nine in ten stayed within ", /*#__PURE__*/React.createElement("b", null, stPct(a.p90_beyond_pct * 100)), ". The record is ", stPct(a.line.record_pct * 100, 1), "."), vs ? /*#__PURE__*/React.createElement("p", {
      className: "sl-muted",
      title: ST_TIP.vs_monday
    }, "Same 20-delta rule: sold Monday, the strike sat ", stPct(vs.monday.strike_from_anchor_pct * 100, 1), " away and finished through ", stPct0(vs.monday.finished_through * 100), "; sold after the line, it sat", " ", stPct(vs.line.strike_from_anchor_pct * 100, 1), " away and finished through ", stPct0(vs.line.finished_through * 100), ".") : null);
  };
  const live = data && data.live || [];
  return /*#__PURE__*/React.createElement("div", {
    className: "card st-line-card",
    style: {
    ...
    className: "kicker",
    title: ST_TIP.card
  }, "After it reaches the line"), /*#__PURE__*/React.createElement("div", {
    className: "card-title"
  }, "What ", ticker, " did once it got to its usual high or low")), live.length ? /*#__PURE__*/React.createElement("div", {
    className: "toolbar"
  }, live.map(r => /*#__PURE__*/React.createElement("span", {
    key: r.key,
    className: `st-state st-state-${r.state}`,
    title: ST_TIP.state
  }, r.state.toUpperCase(), " \xB7 ", r.horizon, " ", r.side, r.strike ? ` · ${stNum(r.strike, 2)}` : ""))) : null), err ? /*#__PURE__*/React.createElement("p", {
    className: "sl-muted"
  }, err) : null, !data && !err ? /*#__PURE__*/React.createElement("div", {
    className: "st-loading",
    "aria-busy": "true"
  }, /*#__PURE__*/React.createElement("div", {
    className: "skel skel-line",
    ...
    className: "st-sides"
  }, ["call", "put"].map(side)) : null, data ? /*#__PURE__*/React.createElement("p", {
    className: "sl-muted",
    style: {
      marginTop: 8
    },
    title: ST_TIP.day_upper
  }, "Measured on ", data.n_weeks, " complete weeks of daily bars, in ", ticker, "'s own sigma (", stPct0(data.sigma_annual * 100, 0), " annualised). Outcomes are counted from the crossing bar on, never from Monday. When the stock is past a line during the session, the At the line board on Trade prices the strikes.") : null);
}

// Chunk registration (house pattern — verify_frontend checks this).
Object.assign(window, {
  StretchCard: React.memo(StretchCard),
  StretchLineCard: React.memo(StretchLineCard)
});
})();
