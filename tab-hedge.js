...
function HfBroader({
  ...
  return /*#__PURE__*/React.createElement("section", {
    ...
    title: HF_TIP.broader
  }, "Broader hedge fund trend ", /*#__PURE__*/React.createElement("span", {
    className: "hf-muted"
  ...
  }, bt.as_of_text ? `Futures positions as of ${bt.as_of_text}` : null, bt.week ? ` · ${hfWeekLabel(bt.week)}` : null, bt.confidence ? ` · confidence ${bt.confidence}` : null), /*#__PURE__*/React.createElement("p", {
    className: "hf-muted"
...
function FundDetail({
  ...
  return /*#__PURE__*/React.createElement("div", {
    ...
    title: HF_TIP.amended
  }, "Amendment"), /*#__PURE__*/React.createElement("th", {
    title: HF_TIP.positions
  }, "Lines"), /*#__PURE__*/React.createElement("th", {
    title: HF_TIP.value
  }, "Value"))), /*#__PURE__*/React.createElement("tbody", null, d.filings.map(f => /*#__PURE__*/React.createElement("tr", {
    key: f.accession
  }, /*#__PURE__*/React.createElement("td", {
    "data-label": "Form"
    ...
    className: "hf-muted"
  }, "Unusual Whales had no parse of this filing.")) : null, d.notes && d.notes.length ? /*#__PURE__*/React.createElement("section", null, /*#__PURE__*/React.createElement("h4", {
    title: HF_TIP.notes
...
function HfNewFilings({
  ...
  return /*#__PURE__*/React.createElement("section", {
    ...
    title: HF_TIP.manager
  }, "Manager"), /*#__PURE__*/React.createElement("th", {
    title: HF_TIP.form
  }, "Form"), /*#__PURE__*/React.createElement("th", {
    title: HF_TIP.filed_as
  }, "Filed as"))), /*#__PURE__*/React.createElement("tbody", null, rows.map(r => /*#__PURE__*/React.createElement("tr", {
...
function PulsePanel({
  ...
  return /*#__PURE__*/React.createElement("div", {
  ...
  }, hfWeekLabel(d.week)), dates.cftc_as_of ? /*#__PURE__*/React.createElement("span", {
    title: HF_TIP.pulse_cftc
    ...
    title: HF_TIP.pulse_changed
  }, "What changed since last week"), d.changed.available ? d.changed.n ? /*#__PURE__*/React.createElement("ul", {
    className: "hf-notes"
    ...
    apiFetch: apiFetch,
    onOpenTicker: onOpenTicker
  }), /*#__PURE__*/React.createElement(HfAlerts, {
    apiFetch: apiFetch
  }), /*#__PURE__*/React.createElement(HfHealth, {
    apiFetch: apiFetch
    ...
    title: HF_QUESTION_NAME.exposure
  }, "Exposure"), /*#__PURE__*/React.createElement("th", {
    title: HF_QUESTION_NAME.leverage
  }, "Leverage"), /*#__PURE__*/React.createElement("th", {
    title: HF_QUESTION_NAME.longs
  }, "Longs"), /*#__PURE__*/React.createElement("th", {
    title: HF_QUESTION_NAME.shorts
  }, "Shorts"), /*#__PURE__*/React.createElement("th", {
    title: HF_TIP.pulse_crowd
    ...
    "data-label": "Week"
  }, hfWeekLabel(h.week)), /*#__PURE__*/React.createElement("td", {
    "data-label": "Exposure"
...
function HfCompare({
  ...
  return /*#__PURE__*/React.createElement("section", {
    ...
    title: HF_TIP.report_compare
  }, hfWeekLabel(cmp.older.week), " compared with ", hfWeekLabel(cmp.newer.week)), /*#__PURE__*/React.createElement("p", {
    className: "sl-status"
  }, /*#__PURE__*/React.createElement("span", {
    title: HF_TIP.as_of
  }, hfWeekLabel(cmp.older.week), ": positions as of ", cmp.older.as_of_text || "—"), /*#__PURE__*/React.createElement("span", {
    title: HF_TIP.as_of
  }, " \xB7 ", hfWeekLabel(cmp.newer.week), ": positions as of ", cmp.newer.as_of_text || "—"), /*#__PURE__*/React.createElement("span", {
    title: HF_TIP.report_compare
  ...
  }, hfWeekLabel(cmp.older.week)), /*#__PURE__*/React.createElement("th", {
    title: HF_TIP.report_week
  }, hfWeekLabel(cmp.newer.week)), /*#__PURE__*/React.createElement("th", {
    title: HF_TIP.report_compare
    ...
    "data-label": hfWeekLabel(cmp.older.week)
    ...
    "data-label": hfWeekLabel(cmp.newer.week)
...
function HfAlerts({
  ...
  const load = React.useCallback(async () => {
    ...
    try {
      const {
        d: got,
        err: readErr
      } = await hfReadJson(await apiFetch("/api/hf/alerts", {
        noCache: true
      }));
      if (!got) throw new Error(readErr || "no data");
      setD(got);
  ...
  if (err) return /*#__PURE__*/React.createElement("section", null, /*#__PURE__*/React.createElement("h4", {
    title: HF_TIP.alerts
  }, "What would reach your phone"), /*#__PURE__*/React.createElement("p", {
    className: "research-error"
  }, err));
  if (!d) return /*#__PURE__*/React.createElement("section", null, /*#__PURE__*/React.createElement("h4", {
    title: HF_TIP.alerts
  ...
  return /*#__PURE__*/React.createElement("section", {
    ...
    title: HF_TIP.alerts_can_send
  }, d.can_send ? "Push is set up on this deployment" : "No push is set up, so nothing is sent"), /*#__PURE__*/React.createElement("span", {
    title: HF_TIP.alerts_primed
  }, " · ", d.primed ? "watching for changes" : "not yet primed — the first pass stays silent"), /*#__PURE__*/React.createElement("span", {
    title: HF_TIP.alerts_sent
  }, " \xB7 ", hfInt(d.n_sent), " sent so far"), /*#__PURE__*/React.createElement("span", {
    title: HF_TIP.alerts_cap
  }, " \xB7 at most ", hfInt(d.cap_per_run), " at a time"), " ", /*#__PURE__*/React.createElement("button", {
    className: "hf-link",
    onClick: load,
    disabled: busy,
    title: "Check again"
  }, "reload")), d.would_send && d.would_send.length ? /*#__PURE__*/React.createElement("div", null, /*#__PURE__*/React.createElement("h5", {
    title: HF_TIP.alerts_would
  }, "Would go out on the next check"), /*#__PURE__*/React.createElement("ul", {
    className: "hf-notes"
  }, d.would_send.map(r => /*#__PURE__*/React.createElement("li", {
    key: r.key,
    title: HF_TIP.alerts_would
  }, /*#__PURE__*/React.createElement(HfTag, {
    cls: r.class
  }), " ", /*#__PURE__*/React.createElement("b", null, (r.rendered || {}).title), " \u2014 ", (r.rendered || {}).message)))) : /*#__PURE__*/React.createElement("p", {
    className: "hf-muted",
    title: HF_TIP.alerts_quiet
  }, "Nothing is waiting to go out. Most weeks that is the correct answer, not a failure \u2014 these fire on a change, and most weeks nothing changes."), d.sent && d.sent.length ? /*#__PURE__*/React.createElement("div", null, /*#__PURE__*/React.createElement("h5", {
    title: HF_TIP.alerts_sent
  }, "Already sent"), /*#__PURE__*/React.createElement("div", {
    className: "scan-table-wrap hf-table-wrap"
  }, /*#__PURE__*/React.createElement("table", {
    className: "scan-table mtable hf-table"
  }, /*#__PURE__*/React.createElement("thead", null, /*#__PURE__*/React.createElement("tr", null, /*#__PURE__*/React.createElement("th", {
    ...
    title: HF_TIP.alerts_kind
  }, "Kind"), /*#__PURE__*/React.createElement("th", {
    title: HF_TIP.alerts_sent
  }, "What it said"))), /*#__PURE__*/React.createElement("tbody", null, d.sent.map(r => /*#__PURE__*/React.createElement("tr", {
    key: r.key
  }, /*#__PURE__*/React.createElement("td", {
    "data-label": "When",
    title: HF_TIP.alerts_sent
  }, hfDateTime(r.at)), /*#__PURE__*/React.createElement("td", {
    "data-label": "Kind",
    title: HF_TIP.alerts_kind
  }, r.kind || "—"), /*#__PURE__*/React.createElement("td", {
    "data-label": "What it said"
  }, r.message))))))) : null, d.held && d.held.length ? /*#__PURE__*/React.createElement("div", null, /*#__PURE__*/React.createElement("h5", {
    title: HF_TIP.alerts_held
  }, "Seen, and deliberately not sent"), /*#__PURE__*/React.createElement("ul", {
    className: "hf-notes"
  }, d.held.slice(0, 8).map(r => /*#__PURE__*/React.createElement("li", {
    key: r.key,
    className: "hf-muted",
    title: HF_TIP.alerts_held
  }, r.kind, " \u2014 ", r.held)))) : null, /*#__PURE__*/React.createElement("p", {
    className: "hf-muted",
    title: HF_TIP.alerts
  }, d.note));
}
const HF_HEALTH_CLASS = {
  "WORKING": "hf-ok",
  "STALE": "hf-warn",
  "NOT ANSWERING": "hf-bad",
  "NOT CONFIGURED": "hf-muted-state",
  "NOT CHECKED": "hf-muted-state"
};
function HfHealth({
  apiFetch
}) {
  ...
  const load = React.useCallback(async () => {
    ...
    try {
      const {
        d: got,
        err: readErr
      } = await hfReadJson(await apiFetch("/api/hf/health", {
        noCache: true
      }));
      if (!got) throw new Error(readErr || "no data");
      setD(got);
      ...
      const {
        d: day
      } = await hfReadJson(await apiFetch("/api/hf/daily", {
        noCache: true
      }));
      setDaily(day || null);
    } catch (e) {
  ...
  if (err) return /*#__PURE__*/React.createElement("section", null, /*#__PURE__*/React.createElement("h4", {
    title: HF_TIP.health
  }, "Are the sources working?"), /*#__PURE__*/React.createElement("p", {
    className: "research-error"
  }, err));
  if (!d) return /*#__PURE__*/React.createElement("section", null, /*#__PURE__*/React.createElement("h4", {
    title: HF_TIP.health
  ...
  return /*#__PURE__*/React.createElement("section", {
    ...
    title: HF_TIP.health
  }, d.headline), /*#__PURE__*/React.createElement("span", {
    className: "hf-muted",
    title: HF_TIP.obs
  }, " · ", hfInt((d.log || {}).n_lines), " readings on record"), " ", /*#__PURE__*/React.createElement("button", {
    className: "hf-link",
    onClick: load,
    disabled: busy,
    title: "Ask again"
  }, "reload")), d.note ? /*#__PURE__*/React.createElement("p", {
    className: "hf-muted",
    title: HF_TIP.health
  }, d.note) : null, /*#__PURE__*/React.createElement("div", {
    className: "scan-table-wrap hf-table-wrap"
  }, /*#__PURE__*/React.createElement("table", {
    className: "scan-table mtable hf-table"
  }, /*#__PURE__*/React.createElement("thead", null, /*#__PURE__*/React.createElement("tr", null, /*#__PURE__*/React.createElement("th", {
    ...
    title: HF_TIP.health_state
  }, "State"), /*#__PURE__*/React.createElement("th", {
    title: HF_TIP.health_cadence
  }, "Publishes"), /*#__PURE__*/React.createElement("th", {
    title: HF_TIP.health_newest
  }, "Newest data"), /*#__PURE__*/React.createElement("th", {
    title: HF_TIP.health_last
  }, "Last answered"), /*#__PURE__*/React.createElement("th", {
    title: HF_TIP.health_state
  }, "What that means"))), /*#__PURE__*/React.createElement("tbody", null, (d.rows || []).map(r => /*#__PURE__*/React.createElement("tr", {
    key: r.source
  }, /*#__PURE__*/React.createElement("td", {
    "data-label": "Source"
    ...
    className: `hf-state ${HF_HEALTH_CLASS[r.state] || ""}`
  }, r.state)), /*#__PURE__*/React.createElement("td", {
    "data-label": "Publishes",
    title: HF_TIP.health_cadence
  }, r.cadence || "—"), /*#__PURE__*/React.createElement("td", {
    "data-label": "Newest data",
    title: HF_TIP.health_newest
  }, hfDate(r.newest_as_of)), /*#__PURE__*/React.createElement("td", {
    "data-label": "Last answered",
    title: HF_TIP.health_last
  }, r.last_ok ? hfDateTime(r.last_ok) : /*#__PURE__*/React.createElement("span", {
    className: "hf-muted"
  }, "never")), /*#__PURE__*/React.createElement("td", {
    "data-label": "What that means"
  }, r.why)))))), /*#__PURE__*/React.createElement("button", {
    className: "hf-link",
    onClick: () => setOpen(!open),
    title: HF_TIP.daily
  }, open ? "hide the day-by-day record" : "show the day-by-day record"), open ? /*#__PURE__*/React.createElement("div", {
    className: "hf-daily"
  }, /*#__PURE__*/React.createElement("h5", {
    title: HF_TIP.daily
  }, "What each source has said, day by day"), /*#__PURE__*/React.createElement("p", {
    className: "hf-muted",
    title: HF_TIP.daily_depth
  }, (daily || {}).depth_note || "—"), daily && daily.rows && daily.rows.length ? /*#__PURE__*/React.createElement("div", {
    className: "scan-table-wrap hf-table-wrap"
  }, /*#__PURE__*/React.createElement("table", {
    className: "scan-table mtable hf-table"
  }, /*#__PURE__*/React.createElement("thead", null, /*#__PURE__*/React.createElement("tr", null, /*#__PURE__*/React.createElement("th", {
    ...
    title: HF_TIP.daily_points
  }, "Days on record"), /*#__PURE__*/React.createElement("th", {
    title: HF_TIP.as_of
  }, "Reaches back to"), /*#__PURE__*/React.createElement("th", {
    title: HF_TIP.as_of
  }, "Newest"), /*#__PURE__*/React.createElement("th", {
    title: HF_TIP.daily
  }, "Latest reading"))), /*#__PURE__*/React.createElement("tbody", null, daily.rows.map(r => {
    ...
    return /*#__PURE__*/React.createElement("tr", {
      ...
      "data-label": "Days on record",
      title: HF_TIP.daily_points
    }, hfInt(r.n_days)), /*#__PURE__*/React.createElement("td", {
      "data-label": "Reaches back to"
    }, hfDate(r.first)), /*#__PURE__*/React.createElement("td", {
      "data-label": "Newest"
    }, hfDate(r.last)), /*#__PURE__*/React.createElement("td", {
      "data-label": "Latest reading"
    }, last && last.value != null ? hfInt(last.value) : "—", last && last.change != null ? /*#__PURE__*/React.createElement("span", {
      className: "hf-muted"
    }, " (", hfSigned(last.change), ")") : null));
  })))) : null) : null);
}
function HfGrades({
  apiFetch
...
function ReportPanel({
  ...
  return /*#__PURE__*/React.createElement("div", {
    ...
    title: HF_TIP.report_week
  }, hfWeekLabel(d.week)), d.dates && d.dates.as_of ? /*#__PURE__*/React.createElement("span", {
    title: HF_TIP.pulse_cftc
    ...
    title: HF_TIP.as_of
  }, "Positions as of"), /*#__PURE__*/React.createElement("th", {
    title: HF_QUESTION_NAME.exposure
  }, "Exposure"), /*#__PURE__*/React.createElement("th", {
    title: HF_QUESTION_NAME.leverage
  }, "Leverage"), /*#__PURE__*/React.createElement("th", {
    ...
    title: HF_TIP.report_revision
  }, "Revisions"), /*#__PURE__*/React.createElement("th", {
    title: HF_TIP.report_history
  }))), /*#__PURE__*/React.createElement("tbody", null, history.map(h => /*#__PURE__*/React.createElement("tr", {
    key: h.week
  }, /*#__PURE__*/React.createElement("td", {
    "data-label": "Week"
  }, hfWeekLabel(h.week)), /*#__PURE__*/React.createElement("td", {
    ...
    key: w,
    value: w
  }, hfWeekLabel(w))))), /*#__PURE__*/React.createElement("label", {
    title: HF_TIP.report_compare
    ...
    key: w,
    value: w
  }, hfWeekLabel(w))))), /*#__PURE__*/React.createElement("button", {
    className: "sl-mode",
    onClick: runCompare,
    disabled: !cmpA || !cmpB,
    title: HF_TIP.report_compare
