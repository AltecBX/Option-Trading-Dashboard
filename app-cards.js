...
function FinvizPanel({
  ...
  const TICKER_LINKS = [["Quote & chart", `${B}/quote.ashx?t=${ticker}&p=d`, "The full Finviz quote page for the active ticker — chart, fundamentals, analyst ratings, insider trades, and news in one view."], ["Intraday chart", `${B}/quote.ashx?t=${ticker}&p=i1`, "Finviz 1-minute intraday chart (Elite real-time)."], ["News", `${B}/quote.ashx?t=${ticker}&p=d#news`, "Ticker news feed on the quote page."]];
  const GLOBAL_LINKS = [["Screener", `${B}/screener.ashx`, "Your Finviz screener — all saved Elite screens live in your account and appear here."], ["Portfolio / Watchlists", `${B}/portfolio.ashx`, "Your saved Finviz watchlists and portfolios (account-synced)."], ["Map", `${B}/map.ashx?t=sec`, "S&P 500 heat map by sector."], ["Groups", `${B}/groups.ashx`, "Sector & industry group performance."], ["Futures", `${B}/futures.ashx`, "Futures dashboard."], ["Insider", `${B}/insidertrading.ashx`, "Latest insider buys and sells market-wide."], ["Market news", `${B}/news.ashx`, "Finviz market-wide news and blogs feed."], ["Earnings", `${B}/calendar.ashx`, "Economic & earnings calendar."]];
  return /*#__PURE__*/React.createElement("div", {
    ...
    className: "kicker",
    title: "Finviz forbids embedding inside other sites (X-Frame-Options) and browsers forbid sharing its login cookies cross-origin — so instead of a broken iframe, the dashboard drives ONE named Finviz window. Log in there once with your Elite account; the session lives in your browser exactly like a normal Finviz tab (it IS finviz.com), stays across visits per Finviz's own login persistence, and everything — saved screens, watchlists, settings — is your real account, synced everywhere."
  }, "finviz elite companion · ", connected ? "connected" : "not connected"), /*#__PURE__*/React.createElement("div", {
    className: "card-title"
  }, "Finviz — driven by your dashboard")), /*#__PURE__*/React.createElement("span", {
    className: `fv-status ${connected ? "on" : ""}`,
    title: connected ? "The companion window is open. Ticker switches in the app navigate it automatically while Follow is on." : "No companion window yet — click 'Open Finviz' below. Your browser requires the first open to be a click (popup rules); after that the app can drive it."
  }, connected ? "● live" : "○ closed")), /*#__PURE__*/React.createElement("div", {
    className: "fv-controls"
  }, /*#__PURE__*/React.createElement("button", {
    className: "rr-btn fv-main",
    onClick: () => open(FINVIZ.quoteUrl(ticker)),
  ...
  }, "Open Finviz → ", ticker), /*#__PURE__*/React.createElement("button", {
  ...
  }, "Follow ticker ", follow ? "ON" : "OFF"), /*#__PURE__*/React.createElement("div", {
    className: "seg",
    title: "Which Finviz domain to drive. Elite = your paid real-time account (elite.finviz.com). Free = the public site."
    ...
    className: "fv-note",
    title: "Why not embedded in the page? Finviz sends X-Frame-Options: SAMEORIGIN — the browser refuses to render it inside dashboard.jerrytrade.com, and working around that (proxy re-hosting) would break your login and violate their terms. The companion window is the compliant equivalent: same screen real estate side-by-side, your real session, zero re-typing of tickers."
  }, "Put the companion on a second monitor or split screen — the dashboard is the remote control. Log in once; Finviz keeps you signed in like any normal visit, and your saved screens / watchlists / settings are your real account, synced everywhere."), /*#__PURE__*/React.createElement("div", {
    className: "fv-grid-title",
    title: "Pages for the ACTIVE dashboard ticker."
  }, "For ", ticker), /*#__PURE__*/React.createElement("div", {
    className: "fv-grid"
  }, TICKER_LINKS.map(([l, u, tip]) => /*#__PURE__*/React.createElement("button", {
    key: l,
    className: "fv-link",
    onClick: () => open(u),
    title: tip
    ...
    className: "fv-grid-title",
    title: "Account-level Finviz tools. Everything you save there is stored in your Finviz account — visible on any device."
  }, "Your Finviz"), /*#__PURE__*/React.createElement("div", {
    className: "fv-grid"
  }, GLOBAL_LINKS.map(([l, u, tip]) => /*#__PURE__*/React.createElement("button", {
    key: l,
    className: "fv-link",
    onClick: () => open(u),
    title: tip
