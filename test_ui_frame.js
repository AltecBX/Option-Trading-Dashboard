...
// ── v5.33: the Big Money Map ──────────────────────────────────────────────
{
  ...
  ok("the Big Money Map is on the Flow tab, inside an error boundary",
     /<CardErrorBoundary label="Big Money Map">\s*<MoneyMapCard /.test(app)
     && /MoneyMapCard: _memo\(MoneyMapCard\)/.test(cards));
